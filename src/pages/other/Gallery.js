    ...
    return (
        <Fragment>
            ...
            <LayoutOne headerTop="visible">
                ...
                <Box
                    className="container pt-100 pb-100"
                    sx={{ minWidth: 400, overflowClipBox: 'scroll' }}
                >
                    <ImageList variant="masonry" cols={3} gap={24}>
                        {itemData.map((item) => (
                            <ImageListItem
                                // className="w-75 h-75 d-flex justify-content-center align-items-center"
                                key={item.img}
                            >
                                <img
                                    // src={process.env.REACT_APP_API + "/static/components/" + item}
